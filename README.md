...
influx-cli --host influx.example.com --port 443 --ssl --unsafeSsl
influx-cli repl
influx-cli tui
influx-cli config show
```

Running `influx-cli` without a subcommand starts the REPL. The explicit `influx-cli repl` form remains supported.
