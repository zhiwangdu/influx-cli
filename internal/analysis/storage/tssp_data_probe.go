...
func tsspDataBlockFilterRows(blocks map[string]tsspDetachedDataBlockInfo, filters []FieldFilter, anyFilters []FieldFilter, rows int) ([]bool, int, bool) {
	if len(filters) == 0 && len(anyFilters) == 0 {
