...
func TestAnalyzeTSSPDetachedAnyFieldFilterMatchesEitherPredicate(t *testing.T) {
	...
	wantFilterStep := DecodePathCursorStep{
		...
		Key:               "meta-index-id:42/row:0",
		CandidateValue:    "row=0 time=333 required=0/0 any=1/2 none=0/0 skips=0/1/0 values=value=99 decision=any:value:=:99:match result=match",
		CursorIndexBefore: 0,
		CursorIndexAfter:  1,
		CursorAdvanced:    true,
	}
...
func TestAnalyzeTSSPDetachedNoneFieldFilterRejectsMatchingRows(t *testing.T) {
	...
	wantFilterStep := DecodePathCursorStep{
		...
		Key:               "meta-index-id:42/row:0",
		CandidateValue:    "row=0 time=333 required=0/0 any=0/0 none=1/1 skips=0/0/0 values=value=99 decision=none:value:=:99:match result=reject_none",
		CursorIndexBefore: 0,
		CursorIndexAfter:  1,
		CursorAdvanced:    true,
	}
