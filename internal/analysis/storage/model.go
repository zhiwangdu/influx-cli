...
type DecodePathSummary struct {
	...
	DataBlockProbeRecordRows          int                       `json:"data_block_probe_record_rows,omitempty"`
	DataBlockProbeRecordSamples       int                       `json:"data_block_probe_record_samples,omitempty"`
	DataBlockProbeRecordOutputs       int                       `json:"data_block_probe_record_outputs,omitempty"`
	DataBlockProbeRecordRangeRejects  int                       `json:"data_block_probe_record_range_rejects,omitempty"`
	DataBlockProbeRecordFilterRejects int                       `json:"data_block_probe_record_filter_rejects,omitempty"`
...
func decodePathText(summary *DecodePathSummary) string {
	...
	if summary.DataBlockProbeRecordRows > 0 || summary.DataBlockProbeRecordRangeRejects > 0 || summary.DataBlockProbeRecordFilterRejects > 0 {
		parts = append(parts, fmt.Sprintf("record_filter rows=%d outputs=%d range_rejects=%d filter_rejects=%d samples=%d", summary.DataBlockProbeRecordRows, summary.DataBlockProbeRecordOutputs, summary.DataBlockProbeRecordRangeRejects, summary.DataBlockProbeRecordFilterRejects, summary.DataBlockProbeRecordSamples))
	}
...
func executionDiagnosticsSummaryText(summary *DecodePathSummary) string {
	...
	rangeTotalActionText := countMapText(summary.RangeExecutionTotalActions)
...
func populateDecodePathTotalExecutionActionCounts(summary *DecodePathSummary) {
	if summary == nil {
		return
	}
	summary.RangeExecutionTotalActions = positiveCountMap(map[string]int{
		"range_row_match":  summary.DataBlockProbeRangeMatches,
		"range_row_reject": summary.DataBlockProbeRangeRejects,
	})
	summary.RecordExecutionTotalActions = positiveCountMap(map[string]int{
		"record_row_output":        summary.DataBlockProbeRecordOutputs,
		"record_row_range_reject":  summary.DataBlockProbeRecordRangeRejects,
		"record_row_filter_reject": summary.DataBlockProbeRecordFilterRejects,
	})
	summary.FilterExecutionTotalActions = positiveCountMap(map[string]int{
		"filter_row_match":  summary.DataBlockProbeFilterMatches,
		"filter_row_reject": summary.DataBlockProbeFilterRejects,
	})
	summary.FilterClauseTotalActions = positiveCountMap(map[string]int{
		"filter_required_match": summary.DataBlockProbeRequiredHits,
		"filter_required_miss":  summary.DataBlockProbeRequiredMiss,
		"filter_required_skip":  summary.DataBlockProbeRequiredSkips,
		"filter_any_match":      summary.DataBlockProbeAnyHits,
		"filter_any_miss":       summary.DataBlockProbeAnyMiss,
		"filter_any_skip":       summary.DataBlockProbeAnySkips,
		"filter_none_match":     summary.DataBlockProbeNoneHits,
