...
| meta command | MVP/Phase 1 | `:use`、`:db`、`:dbs`、`:rps`、`:measurements`、`:msts`、`:fields`、`:tags`、`:schema`、`:refresh schema`、`:format`、`:history`、`:cancel` |
...
| meta command | `:use`、`:db`、`:dbs`、`:rps`、`:measurements`、`:msts`、`:fields`、`:tags`、`:schema`、`:refresh schema`、`:format`、`:history`、`:cancel` |
