...
| mergeset | 已有 part metadata、metaindex row、index block-header、item payload summary、openGemini TSI/tag namespace item summary、openGemini field-index namespace item summary、payload-backed part/file-set table scan summary、file-set item search simulation、TableSearch seek/heap cursor simulation 和 duplicate item merge/dedup summary；后续补充完整本地 multi-part table cursor simulation/execution |
