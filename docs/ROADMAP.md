...
| mergeset | 已有 part metadata、metaindex row、index block-header、item payload summary 和 file-set item search simulation；后续补充 storage-engine-backed table cursor simulation |
